...
# It is assumed that this python script and main.c are in the same directory

BlockType = Literal["uint8_t", "uint16_t", "uint32_t"]
...
if __name__ =="__main__":
    ...
    compile(c_file_path, exec_name, "uint32_t")
